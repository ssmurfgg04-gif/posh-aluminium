...
const INDUSTRIES = [
  ...
  { icon: Home, name: "Luxury Residential", scope: "Slimline sliding / Frameless glass / Shower cubicles", pain: "Slim sightlines without compromising weather performance. Integration with complex architectural geometries and bespoke finishes.", example: "Karen Luxury Villa: 260 m² frameless facade, 4-track lift-and-slide", image: "https://sfile.chatglm.cn/images-ppt/0024c6d74d40.jpg" },
  { icon: Hotel, name: "Hospitality", scope: "Acoustic windows / Partitions / Pool-deck screening", pain: "Acoustic isolation for guest comfort (STC 38+), anti-lime coatings for wet areas, brand-standard finish quality across 100+ rooms.", example: "Radisson Blu Upper Hill: 180 rooms, STC 38 windows", image: "https://sfile.chatglm.cn/images-ppt/8fb05022dd78.jpg" },
  { icon: Hospital, name: "Healthcare", scope: "Hermetic windows / Cleanroom partitions / Lead-lined glazing", pain: "Hygiene-grade finishes, hermetically sealed operable windows, lead-lined glazing for imaging suites. Zero tolerance for shortcuts.", example: "Aga Khan Hospital: cardiac wing, lead-lined imaging", image: "https://sfile.chatglm.cn/images-ppt/7c5d190eeeb0.jpg" },
  { icon: GraduationCap, name: "Education", scope: "Acoustic partitions / Security glazing / Atriums", pain: "Acoustic isolation between teaching spaces, security-rated glazing on ground floors, daylight-filled atriums for collaborative learning.", example: "Brookhouse School: science block, 380 m² atrium", image: "https://sfile.chatglm.cn/images-ppt/2312697e1bf1.jpg" },
  { icon: ShoppingBag, name: "Retail & Malls", scope: "Atrium curtain wall / Skylights / Walk-on glazing", pain: "Large-span atrium glazing, integrated ETFE skylights, walk-on glass for circulation, tenant-fit coordination.", example: "Two Rivers Mall: 9,000 m² atrium, ETFE skylight", image: "https://sfile.chatglm.cn/images-ppt/7e42ed57f175.jpg" },
];

export function Industries() {
  return (
    <section id="industries" className="scroll-mt-nav py-24 sm:py-32 px-4 sm:px-6 lg:px-8 bg-mist/40 dark:bg-card/20">
